...
HD_PWD='/tools/Xilinx/2025.1/Vivado/bin/ALU_FINAL/ALU_FINAL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_placa.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_placa.tcl
