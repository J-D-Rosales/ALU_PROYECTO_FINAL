...
HD_PWD='/tools/Xilinx/2025.1/Vivado/bin/ALU_FINAL/ALU_FINAL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_placa.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_placa.tcl -notrace
